                ...
                <tr key={index} className="border-b border-gray-200">
                  ...
                  <td className="px-4 py-2 flex justify-center">
                    <button
                      ...
                      className="w-20 rounded-md border-none text-sm bg-blue-500 p-2 text-white mx-2 hover:bg-blue-600 focus:outline-none focus:bg-blue-600 transition duration-300"
                    >
                      View
                    </button>
